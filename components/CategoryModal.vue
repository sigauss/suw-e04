<template>
    <div v-if="$store.getters.category_modal_state" class="category__modalLayout fade-in">
        <div class="category__modal view-top">
      ...
      return axios
        .put(
          `https://api.github.com/repos/${
            ...
            this.categoryName
          }/README.md?access_token=${this.$store.getters.access_token}`,
          {
